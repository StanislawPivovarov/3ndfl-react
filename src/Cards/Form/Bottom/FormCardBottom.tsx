    ...
    <FormsCardBottom className="form" style={props.style}>
      <WrapperCard className="form-wrapper">
        ...
        >
          ...
          <InputHeader className="ndfl-purpose">
            На что у Вас 3-НДФЛ
          </InputHeader>
          <Select
          ...
          <div className="form-whatsapp" style={props.wa}>
            <WhatsapParagraph className="whatsapp-txt">
              Напите нам в WhatsApp
            </WhatsapParagraph>
