      ...
      <Row justify="center">
        <Col xs={23} md={22} lg={20} xl={24}>
          <MainPageHeader className="main-page-header">
            <a href="#"><Logotype src={logo} className="main-page-logo" alt="logo" /></a>
            ...
            <ButtonPosition className="button-wrap">
              <Button ghost>
                <ButtonWrap className="button-wrapper">
                  <svg width="22" height="22" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg" style={{fill: "currentcolor"}}>
