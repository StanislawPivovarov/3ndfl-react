      ...
      <Row justify="center">
        <Col xs={23} md={22} lg={20} xl={19}>
          ...
          <RoadMapItems
            ...
            description="Подайте декларацию и все необходимые документы к ней в налоговую любым удобным для Вас способом. Или доверьте это нам, выбрав тариф Всё включено - VI"
          />
        </Col>
      </Row>
    </WorkWrapper>
